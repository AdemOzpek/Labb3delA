...
public class World {
    ...
    public World(double width, double height) {
        ...
        shapes[0] = new Line(100,0,0,100,Color.RED);
        shapes[0].setVelocity(20,40);
        shapes[1] = new Rectangle(20,20,100,100,Color.BLACK,true);
        shapes[1].setVelocity(30,20);
        shapes[2] = new Circle(0,0, 100, Color.DARKGREEN, true);
        shapes[2].setVelocity(10,20);
